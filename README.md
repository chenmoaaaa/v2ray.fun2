...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ugvf2009/v2ray.fun2/master/install.sh)"
```

## 升级命令
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ugvf2009/v2ray.fun2/master/upgrade.sh)"
```

## 卸载命令
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/ugvf2009/v2ray.fun2/master/uninstall.sh)"
```
